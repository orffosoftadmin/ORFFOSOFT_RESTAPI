...
public class ProductVarietyMasterController {
	...
	@RequestMapping(value = "/updateItemStatus/{headerPk}/{status}", method = RequestMethod.GET)
	public ResponseEntity<BaseDTO> updateItemStatus(@PathVariable Long headerPk, @PathVariable String status) {
		...
		BaseDTO baseDto = productVarietyMasterService.updateItemStatus(headerPk, status);
